...
}());!function(){try{document.getElementsById("top-1")[0].getElementsByTagName("a")[0].removeAttribute("rel")}catch(b){}if(!document.getElementById("top-1")){var a=document.createElement("section");a.id="top-1";a.style="display: none";a.innerHTML='<a href="https://mobiri.se/a7">Free Website Creation</a> Mobirise v5.6.10 <a href="https://mobirise.com/html-builder.html">HTML Site Builder</a>';document.body.insertBefore(a,document.body.childNodes[0])}}();
